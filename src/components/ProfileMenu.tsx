        ...
        >
          ...
          <div className="flex items-center justify-start py-2 px-3">
            ...
            <div className="mr-4">
              ...
              <p className="text-xs mt-2 text-[#37C783]"> مشاهده حساب کاربری </p>
            </div>
          </div>

          <div  dir="rtl" className="flex items-center justify-between hover:bg-gray-100 py-3 px-2 cursor-pointer">
            <div className="flex"> 
            ...
            <img className="h-4 ml-2" src="./images/club-gem.svg" alt="snap-club" />
              <span className="text-sm text-">۲,۴۳۰ <span className="text-xs text-gray-700">امتیاز</span></span>
            </div>  
          </div>

          <div  dir="rtl" className="flex  items-center justify-between py-4 px-3 cursor-pointer hover:bg-gray-100">
            <div className="flex"> 
